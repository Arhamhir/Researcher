...
# get_embedding() is a local lexical (hashed bag-of-words) vector, not a
# semantic embedding - Groq has no embeddings API. This threshold is tuned
# for catching near-duplicate/overlapping text, not paraphrased similarity.
